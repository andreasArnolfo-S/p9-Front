  ...
  return (`
    <div class='layout'>
      ...
      <div class='content'>
        ...
        <div class="form-newbill-container content-inner" data-testid="new-bill-page">
          <form data-testid="form-new-bill">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button data-testId="submit-button" type="submit" id='btn-send-bill' class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
